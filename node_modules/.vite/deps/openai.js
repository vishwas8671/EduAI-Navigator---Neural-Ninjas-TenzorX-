...
var OpenAI = class {
  ...
  async makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
    ...
    if (!response.ok) {
      if (response.status === 401 && this._workloadIdentityAuth && !((_c = options.__metadata) == null ? void 0 : _c["hasStreamingBody"]) && !((_d = options.__metadata) == null ? void 0 : _d["workloadIdentityTokenRefreshed"])) {
